...
def get_metric(y_true_aspect, y_predict_aspect, y_true_opinion, y_predict_opinion, y_true_sentiment,
    ...
    # print y_true_aspect
    # print y_predict_aspect
    # print y_true_sentiment
    # print y_predict_sentiment
    # print mask
    # print train_op
    f_a, f_o = 0, 0
    ...
    # print('y_true_aspect', np.shape(y_true_aspect))
    # print('y_true_opinion', np.shape(y_true_opinion))
    # print('y_true_sentiment', np.shape(y_true_sentiment))
    # print('true_aspect', np.shape(true_aspect))
    # print('true_sentiment', np.shape(true_sentiment))
    # print('true_opinion', np.shape(true_opinion))
